...
public class FastCash extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource()==b1){
                    ...
                    JOptionPane.showMessageDialog(null,  "+3000"+" Debited Successfully");
                    ...
                    if(rs.next()){
                        ...
                        balance-=4000;
                        String q1= "insert into bank values('"+pin+"',null,4000,'"+balance+"')";
                    ...
                    JOptionPane.showMessageDialog(null, "+4000"+" Debited Successfully");
